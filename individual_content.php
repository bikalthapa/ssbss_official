          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="card mb-3" style="max-width: 50%; margin:auto; border:none;">
              <div class="row g-0">
                ...
                <img style="max-height:350px; border-radius:7px;" src="../uploads/images/<?php echo $thumbnail; ?>"
            ...
            ?>
              <div class="card mb-3" style="max-width:80%; max-height: 100%; margin:auto; border:none;">
                <div class="row g-0">
                  ...
                  <iframe style="border-radius:7px; min-height:500px;"
                    src="../uploads/documents/<?php echo $file_name; ?>"></iframe>
                </div>
              </div>
            <?php
          }
