...
<body>
	...
	if (isset($_GET["news_id"]) || isset($_GET['notice_id'])) {
		...
		?>
		<form class="border-primary card post_form" id="news_update_form"
			style=" margin: auto; padding: 15px; margin-top:10px; max-width:500px;" method="post" action=""
			...
			<div class="mb-3">
				...
				<input type="text" placeholder="Something..." value="<?php echo $row['title']; ?>" describeby="titleHelp"
			...
			<div class="news_section" id="news_section">
				<div class="mb-3">
					...
					<textarea name="news_content" class="form-control border-primary form-control-sm  post_inputs"
						id="description" describeby="descriptionHelp">
				...
				<div class="mb-3">
					...
					<input name="thumbnail" class="form-control border-primary form-control-sm  post_inputs" id="thumbnail"
						describeby="thumbnailHelp" accept="image/*" type="file">
				</div>
				...
				<div class="mb-3">
					...
					<input name="image[]" class="form-control border-primary form-control-sm  post_inputs" id="image"
						multiple describeby="imageHelp" accept="image/*" type="file">
				</div>
		...
		?>
			<form class="border-primary card post_form" style=" margin: auto; padding: 15px; margin-top: 5%; max-width:500px;"
				method="post" action="" enctype="multipart/form-data">
				<div class="mb-3">
					<label class="form-label">Title</label>
					<input type="text" value="<?php echo $title; ?>" placeholder="Something..."
						class="form-control form-control-md border-primary" name="title">
				</div>
				<div class="news_section">
					<div class="mb-3">
						<label for="thumbnail" class="form-label">File<br><?php echo $file_name; ?></label>
						<iframe src="../../uploads/documents/<?php echo $file_name; ?>"
							style="width:100%; margin-bottom:5px;"></iframe>
						<input name="document_file" class="form-control border-primary form-control-sm" id="thumbnail"
				...
				<form method="post" action="" id="result_form" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-sm-6 g-3">
							...
							<div class="row">
								<input class="btn btn-primary w-100 col col-sm-6" type="submit" id="publish_result"
									name="publish_result" value="Publish Result">
								<input class="btn btn-primary w-100 col col-sm-6" type="submit" id="publish_result"
									name="publish_result" value="Publish Result">
							</div>
						</div>
