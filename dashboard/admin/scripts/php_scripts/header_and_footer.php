			...
			<div class="accordion accordion-flush" id="accordionFlushExample">
				...
				<div class="accordion-item">
					<h2 class="accordion-header">
						<button
							class="accordion-button <?php echo $active == "content" ? $act : "" ?> collapsed d-flex align-items-center"
					...
					<div id="flush-collapseContent" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<ul class="list-group">
								<a href="feeds.php" class="list-group-item list-group-item-action fs-bolder">Feeds</a>
								<a href="#" class="disabled list-group-item list-group-item-action">Events</a>
								<a href="#" class="disabled list-group-item list-group-item-action">Gallery</a>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="accordion-item">
					<a href="class_management.php"
						class="accordion-header <?php echo $active == "class" ? $act : "" ?> px-3 py-3 d-flex align-items-center text-dark text-decoration-none">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
							class="bi bi-person-video3 me-2" viewBox="0 0 16 16">
							<path
				...
				<div class="accordion-item">
					...
					<div id="flush-collapseExam" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<ul class="list-group">
								<a href="publish_result.php" class="list-group-item list-group-item-action">Result
									Publish</a>
								<li class="list-group-item disabled">Exam Management</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="accordion-item">
					<h2 class="accordion-header">
						<button
							class="accordion-button <?php echo $active == "user" ? $act : "" ?> collapsed d-flex align-items-center"
							type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseUser"
					...
					<div id="flush-collapseUser" class="accordion-collapse collapse"
						data-bs-parent="#accordionFlushExample">
						<div class="accordion-body">
							<ul class="list-group">
								<a href="user_request.php" class="list-group-item">User Request</a>
								<li class="list-group-item">Teachers</li>
								<li class="list-group-item">Students</li>
								<li class="list-group-item disabled">Management Committee</li>
							</ul>
						</div>
					</div>
				</div>
