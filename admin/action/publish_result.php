    				...
    				<div class="row" style="padding-left:14px;">
    					<label class="form-label">File Template</label>
							<div class="col-sm-6 gx-5 form-check">
							  <input class="form-check-input border-primary" name="template_type" type="radio" value="default" id="default_template" checked oninput="decide_template_viewer()">
							  <label class="form-check-label" for="default_template">
							    Default Template
							  </label>
							</div>
							<div class="col-sm-6 gx-5 form-check">
							  <input class="form-check-input border-primary" name="template_type" type="radio" value="custom" id="custom_template" oninput="decide_template_viewer()">
    			...
    			<div class="col-sm-6 g-3">
    				...
    				<div class="row" style="margin-left:10px;" id="file_unity_div">
						<div class="form-check">
						  <input class="form-check-input border-primary" name="file_unity" type="radio" value="same" id="same" checked>
						  <label class="form-check-label" for="same">
						    All Files have similar template.
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input border-primary" name="file_unity" type="radio" value="different" id="different">
			          ...
			          <div class="design1" id="design1">
			            <div class="row">
			              <div class="text-center header">
			                ...
			                <div class="head_para">
			                  <p class="display-6 school_name text-primary">Shree Shanti Bhagwati Secondary School</p>
			              ...
			              <div class="details">
			                ...
			                <table border="1"  cellspacing="0" cellpadding="5" class="text-center" style="margin:auto; width:100%;">
			                  ...
			                  <tr class="text-primary">
			                    <th></th>
			                    <th colspan="2" style="text-align:left;">GPA: <span class="details_data drop_col"></span></th>
			                    <th colspan="3" style="text-align:left;">Percentage :<span class="details_data drop_col"></span></th>
			                    <th colspan="2" style="text-align:left;">Rank :<span class="details_data drop_col"></span> </th>
			                  </tr>
			                </table>
			                <div class="result_conclusion row row-cols-2">
			                  <div class="col gy-2 gx-5">
			                    <p class="total_students">TOTAL STUDENTS :<span class="details_data drop_col"></span></p>
			                    <p class="remarks">REMAKRS :<span class="details_data"></span></p>
			                  </div>
			                  <div class="col gy-2 gx-5">
			                    <p class="attendance drop_col">ATTENDANCE : <span class="details_data"></span></p>
